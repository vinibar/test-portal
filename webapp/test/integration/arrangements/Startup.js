sap.ui.define([
	"sap/ui/test/Opa5",
	"dev/vinibar/portal/settings/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("dev.vinibar.portal.settings.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "dev.vinibar.portal.settings",
					async: true
				},
				hash: oOptions.hash,
