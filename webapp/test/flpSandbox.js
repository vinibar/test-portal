		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Configuracoes",
									"targetURL": "#Configuracoes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Configuracoes-display": {
								"semanticObject": "Configuracoes",
								"action": "display",
								"description": "Configurações gerais para o Portal Portal",
								"title": "Configuracoes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dev.vinibar.portal.settings",
									"url": sap.ui.require.toUrl("dev/vinibar/portal/settings")
								}
							}
						}
					}
